...
const ProductForm = (props) => {
    ...
    const onSubmit = (e) => {
        ...
        if (!isCategoriesValid(categories) || !isNameValid(name) || !isDateValid(expirationDate)) {
            return alert("Il faut remplir la formulaire parfaitement")
        }
      return  props.onSave({
            name,
            brand,
        ...
        <Form onSubmit={onSubmit}>
            ...
            <FormGroup>
                ...
                <Input
                    ...
                    value={categories}
                    onChange={({ target }) =>{              
                        !categories.includes(parseInt(target.value)) ?  setCategories(oldArray => [...oldArray, parseInt(target.value)]) : setCategories(categories.filter((el)=> el !==parseInt(target.value))) 
                        }
                        }
                >
            ...
            <FormGroup>
                ...
                <Input type="number" min="0" name="itemsInStock" id="itemsInStock" value={itemsInStock}
